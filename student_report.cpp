// student report managment system
// code by Gaurika Sawhney
#include <iostream>
#include <fstream>
#include <iomanip>
using namespace std;
...

{
    int rollno;
    char name[50];
    int eng_marks, math_marks, sci_marks, hindi, cs_marks;
    double average;
    char grade;
...
{
    average = (eng_marks + math_marks + sci_marks + hindi + cs_marks) / 5.0;
    if (average >= 90)
        grade = 'A';
    else if (average >= 80)
        grade = 'B+';
...
void delete_student(int); // deleye particular record
...
// read specific record on based on roll number
...
//delete records with particular roll number
